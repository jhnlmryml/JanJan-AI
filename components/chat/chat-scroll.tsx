...
export default function ChatScroll({
    ...
    const handleScroll = useCallback(() => {
        ...
        if (!viewport || isProgrammaticScroll.current) {
            return;
        }
    ...
    // Automatically follow new messages while the user
...
//                         bg-[#121218]/90 p-4 text-xs font-semibold text-slate-200
//                         shadow-2xl backdrop-blur-md transition-all duration-200
//                         hover:border-blue-500/50 hover:bg-blue-600/30 hover:text-white
//                         active:scale-95
//                     "
//                 >
//                     <ArrowDown className="h-4 w-4 text-blue-400 transition-transform duration-200 group-hover:translate-y-0.5" />
//                 </button>
//             </div>
//
//         </div>
