...
export default function ChatHistoryList({
     ...
     * IMPORTANT:
     *
     * Server render and first client render both have:
     *
     * hydrated = false
     * chats = []
     *
     * Therefore they render the exact same UI.
     *
     * After localStorage has been restored,
     * hydrated becomes true and the actual history
     * is displayed.
     */
    if (!hydrated) {
                                    ...
                                    <>
                                        ...
                                        >
                                            <button
                                                ...
                                                className="p-1.5 text-slate-400 hover:text-blue-300 hover:bg-blue-500/10 rounded transition-colors active:scale-95"
                                                title="Rename chat"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="p-1.5 text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 rounded transition-colors active:scale-95"
                                                title="Delete chat"
                                            >
